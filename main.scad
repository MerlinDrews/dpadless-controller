...
SELECT_BUTTON_LEFT = [44+BUTTON_HOLE_RADIUS/2-0.07,8.4+BUTTON_HOLE_RADIUS/2-0.07,9];
...
translate(JUMP_BUTTON_POS)
  import("freecad/button.stl", convexity=1);
/*  button(
...
translate(SELECT_BUTTON_LEFT)
   import("freecad/long-button.stl",convexity=1);
/*rotate([0,0,90])
  button_long(
